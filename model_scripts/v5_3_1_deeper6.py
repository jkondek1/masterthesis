...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv1 = tf.layers.conv2d(inputs,filters = 16, kernel_size=(2,1), strides = 1)
        conv2 = tf.layers.conv2d(inputs,filters = 16, kernel_size=(3,1), strides = 1)
        conv3 = tf.layers.conv2d(inputs, filters = 16, kernel_size=(4,1), strides = 1)
        conv4 = tf.layers.conv2d(inputs,filters = 16, kernel_size=(5,1), strides = 1)
        conv5 = tf.layers.conv2d(inputs,filters = 16, kernel_size=(6,1), strides = 1)
        conv6 = tf.layers.conv2d(inputs, filters = 16, kernel_size=(7,1), strides = 1)
        conv7 = tf.layers.conv2d(inputs,filters = 16, kernel_size=(8,1), strides = 1)
        conv8 = tf.layers.conv2d(inputs,filters = 16, kernel_size=(9,1), strides = 1)
        
        conv1 = tf.layers.conv2d(conv1,filters = 16, kernel_size=(2,1), strides = 1)
        conv2 = tf.layers.conv2d(conv2,filters = 16, kernel_size=(3,1), strides = 1)
        conv3 = tf.layers.conv2d(conv3, filters = 16, kernel_size=(4,1), strides = 1)
        conv4 = tf.layers.conv2d(conv4,filters = 16, kernel_size=(5,1), strides = 1)
        conv5 = tf.layers.conv2d(conv5,filters = 16, kernel_size=(6,1), strides = 1)
        conv6 = tf.layers.conv2d(conv6, filters = 16, kernel_size=(7,1), strides = 1)
        conv7 = tf.layers.conv2d(conv7,filters = 16, kernel_size=(8,1), strides = 1)
        conv8 = tf.layers.conv2d(conv8,filters = 16, kernel_size=(9,1), strides = 1)
        ...
        conv1 = tf.layers.max_pooling2d(conv1, (391,1), strides = 1)
        conv2 = tf.layers.max_pooling2d(conv2, (385,1), strides = 1)
        conv3 = tf.layers.max_pooling2d(conv3, (379,1), strides = 1)
        conv4 = tf.layers.max_pooling2d(conv4, (373,1), strides = 1)
        conv5 = tf.layers.max_pooling2d(conv5, (367,1), strides = 1)
        conv6 = tf.layers.max_pooling2d(conv6, (361,1), strides = 1)
        conv7 = tf.layers.max_pooling2d(conv7, (355,1), strides = 1)
        conv8 = tf.layers.max_pooling2d(conv8, (349,1), strides = 1)
...
results.to_csv("../results/protonets/v5_3_1_deeper6.csv",index = False)
