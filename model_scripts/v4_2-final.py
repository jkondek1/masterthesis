...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv1 = tf.layers.conv2d(inputs,filters = 128, kernel_size=(3,1), strides = 1)
        conv2 = tf.layers.conv2d(inputs,filters = 128, kernel_size=(4,1), strides = 1)
        conv3 = tf.layers.conv2d(inputs, filters = 128, kernel_size=(5,1), strides = 1)
...
results.to_csv("../results/protonets/v4_2-final_run2.csv",index = False)
