...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv1 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(2,1), strides = (8,1))
        conv2 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(3,1), strides = (8,1))
        conv3 = tf.layers.conv2d(inputs, filters = 64, kernel_size=(4,1), strides = (8,1))
        conv4 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(5,1), strides = (8,1))
        conv5 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(6,1), strides = (8,1))
        conv6 = tf.layers.conv2d(inputs, filters = 64, kernel_size=(7,1), strides = (8,1))
        conv7 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(8,1), strides = (8,1))
        conv8 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(9,1), strides = (8,1))
        ...
        conv8 = tf.layers.max_pooling2d(conv8, (49,1), strides = 1)
...
results.to_csv("../results/protonets/v5_3_1_strides8_run2.csv",index = False)
