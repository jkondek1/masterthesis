...
def load_dataset(split_file='train.txt'):
    ...
    dataset0[0] = np.load('../processed_final_texts/imdb_neg_low_lem.npy')
    dataset1[0] = np.load('../processed_final_texts/imdb_pos_high_lem.npy')
...
x_train0, x_train1 = load_dataset()
...
for epoch in range(num_epochs):
    for episode in range(num_episodes):
        ...
        num_examples = [num_train_0, num_train_1]
...
results.to_csv("../results/protonets/v5_3_1_highpolar.csv",index = False)
