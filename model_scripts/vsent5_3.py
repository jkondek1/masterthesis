...
training = pd.DataFrame(np.zeros([num_epochs,1]))
...
for epoch in range(num_epochs):
    ...
    training.iloc[epoch,0] = best_loss

training.to_csv("../results/protonets_aux/v5_3.csv",index = False)
...
results.to_csv("../results/protonets/vsent5_3.csv",index = False)
