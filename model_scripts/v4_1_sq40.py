...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv1 = tf.layers.conv2d(inputs,filters = 128, kernel_size=(3,100), strides = 1)
        conv2 = tf.layers.conv2d(inputs,filters = 128, kernel_size=(4,100), strides = 1)
        conv3 = tf.layers.conv2d(inputs, filters = 128, kernel_size=(5,100), strides = 1)
...
training.to_csv("../results/protonets_aux/v4_1_sq40.csv",index = False)
...
results.to_csv("../results/protonets/v4_1_sq40.csv",index = False)
