...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv1 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(2,1), strides = (2,1))
        conv2 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(3,1), strides = (3,1))
        conv3 = tf.layers.conv2d(inputs, filters = 64, kernel_size=(4,1), strides = (4,1))
        conv4 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(5,1), strides = (5,1))
        conv5 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(6,1), strides = (6,1))
        conv6 = tf.layers.conv2d(inputs, filters = 64, kernel_size=(7,1), strides = (7,1))
        conv7 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(8,1), strides = (8,1))
        conv8 = tf.layers.conv2d(inputs,filters = 64, kernel_size=(9,1), strides = (9,1))

        conv1 = tf.layers.max_pooling2d(conv1, (198,1), strides = 1)
        conv2 = tf.layers.max_pooling2d(conv2, (132,1), strides = 1)
        conv3 = tf.layers.max_pooling2d(conv3, (99,1), strides = 1)
        conv4 = tf.layers.max_pooling2d(conv4, (79,1), strides = 1)
        conv5 = tf.layers.max_pooling2d(conv5, (66,1), strides = 1)
        conv6 = tf.layers.max_pooling2d(conv6, (56,1), strides = 1)
        conv7 = tf.layers.max_pooling2d(conv7, (49,1), strides = 1)
        conv8 = tf.layers.max_pooling2d(conv8, (41,1), strides = 1)
...
results.to_csv("../results/protonets/v5_3_1_strides.csv",index = False)
