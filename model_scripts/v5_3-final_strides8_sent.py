...
def load_dataset(split_file='train.txt'):
    ...
    dataset0[0] = np.load('../processed_final_texts/imdb_neg_high_lem_sent.npy')
    dataset1[0] = np.load('../processed_final_texts/imdb_neg_low_lem_sent.npy')
    dataset2[0] = np.load('../processed_final_texts/imdb_pos_high_lem_sent.npy')
    dataset3[0] = np.load('../processed_final_texts/imdb_pos_low_lem_sent.npy')
...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv0 = tf.layers.conv2d(inputs,filters = 50, kernel_size=(1,1), strides = (8,1))
        conv1 = tf.layers.conv2d(inputs,filters = 50, kernel_size=(2,1), strides = (8,1))
        conv2 = tf.layers.conv2d(inputs,filters = 50, kernel_size=(3,1), strides = (8,1))
        conv3 = tf.layers.conv2d(inputs, filters = 50, kernel_size=(4,1), strides = (8,1))
        conv4 = tf.layers.conv2d(inputs,filters = 50, kernel_size=(5,1), strides = (8,1))
        conv5 = tf.layers.conv2d(inputs,filters = 50, kernel_size=(6,1), strides = (8,1))
        conv6 = tf.layers.conv2d(inputs, filters = 50, kernel_size=(7,1), strides = (8,1))
        conv7 = tf.layers.conv2d(inputs,filters = 50, kernel_size=(8,1), strides = (8,1))          
        
        conv0 = tf.layers.max_pooling2d(conv0, (49,1), strides = 1)
        conv1 = tf.layers.max_pooling2d(conv1, (49,1), strides = 1)
        conv2 = tf.layers.max_pooling2d(conv2, (49,1), strides = 1)
        conv3 = tf.layers.max_pooling2d(conv3, (49,1), strides = 1)
        conv4 = tf.layers.max_pooling2d(conv4, (49,1), strides = 1)
        conv5 = tf.layers.max_pooling2d(conv5, (49,1), strides = 1)
        conv6 = tf.layers.max_pooling2d(conv6, (49,1), strides = 1)
        conv7 = tf.layers.max_pooling2d(conv7, (49,1), strides = 1)
...
results.to_csv("../results/protonets/v5_3-final_strides8_sent.csv",index = False)
