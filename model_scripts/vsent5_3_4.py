...
def load_dataset(split_file='train.txt'):
    ...
    dataset[0] = np.load("../processed_final_texts/imdb_neg_lem_sent.npy")[:10737]
    dataset[1] = np.load("../processed_final_texts/imdb_pos_lem_sent.npy")
...
def load_test(split_file):
    ...
    dataset0[0] = np.load("../processed_final_texts/neg_lemma_sent.npy")
    dataset1[0] = np.load("../processed_final_texts/pos_lemma_sent.npy")
...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv = tf.keras.layers.Concatenate(axis = 1)([conv0,
                                                      conv1,
                                                      conv2,
                                                      conv3,
                                                      conv4,
...
results.to_csv("../results/protonets/vsent5_3_4.csv",index = False)
