...
def convolution_block1(inputs,name='conv'):
    with tf.variable_scope(name):
        conv = tf.layers.conv2d(inputs, filters = 128, kernel_size=(15,50)) #3,100
        conv = tf.layers.conv2d(inputs, filters = 128, kernel_size=(10,25))
...
results.to_csv("../results/protonets/v3_1_1_hinge.csv",index = False)
