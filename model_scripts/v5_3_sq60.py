...
num_shot = 50#20 # number of examples per class for support set
num_query = 20 #20
...
training.to_csv("../results/protonets_aux/v5_3_sq50.csv",index = False)
...
results.to_csv("../results/protonets/v5_3_sq60.csv",index = False)
