...
def convolution_block1(inputs,batch_size,name='conv'):
    with tf.variable_scope(name):
        ...
        conv1 = tf.layers.max_pooling2d(conv1, (396,100), strides = (1,1))
        conv2 = tf.layers.max_pooling2d(conv2, (395,100), strides = (1,1))
        conv3 = tf.layers.max_pooling2d(conv3, (394,100), strides = (1,1))
        conv4 = tf.layers.max_pooling2d(conv4, (393,100), strides = (1,1))
        conv5 = tf.layers.max_pooling2d(conv5, (392,100), strides = (1,1))
        conv6 = tf.layers.max_pooling2d(conv6, (391,100), strides = (1,1))
        conv7 = tf.layers.max_pooling2d(conv7, (390,100), strides = (1,1))
        conv8 = tf.layers.max_pooling2d(conv8, (389,100), strides = (1,1))
...
results.to_csv("../results/protonets/v5_6.csv",index = False)
